...
import (
	...
	"github.com/iloncar89/banking/domain"
	"github.com/iloncar89/banking/dto"
)

//go:generate mockgen -destination=../mocks/service/mockCustomerService.go -package=service github.com/iloncar89/banking/service CustomerService
